...
// Redis Pub/Sub wakes active clients as commands and state changes arrive.
// These remain deliberately slower fallback intervals for deployments that do
// not have Upstash configured or for a temporarily disconnected SSE stream.
export const SPICE_CONNECT_COMMAND_ACTIVE_POLL_INTERVAL_MS = 2_000;
export const SPICE_CONNECT_COMMAND_IDLE_POLL_INTERVAL_MS = 8_000;
export const SPICE_CONNECT_COMMAND_HIDDEN_POLL_INTERVAL_MS = 20_000;
export const SPICE_CONNECT_COMMAND_IDLE_BACKOFF_POLLS = 3;
export const SPICE_CONNECT_COMMAND_REALTIME_FALLBACK_POLL_INTERVAL_MS = 30_000;
export const SPICE_CONNECT_CONTROLLER_REFRESH_INTERVAL_MS = 5_000;
export const SPICE_CONNECT_CONTROLLER_REALTIME_FALLBACK_REFRESH_INTERVAL_MS = 30_000;
export const SPICE_CONNECT_DEVICE_SYNC_INTERVAL_MS = 60_000;
