...
test('Spice Connect keeps active and background receivers responsive', () => {
  assert.ok(SPICE_CONNECT_COMMAND_ACTIVE_POLL_INTERVAL_MS <= 350);
  assert.ok(SPICE_CONNECT_COMMAND_IDLE_POLL_INTERVAL_MS <= 750);
  assert.ok(SPICE_CONNECT_COMMAND_HIDDEN_POLL_INTERVAL_MS <= 750);
