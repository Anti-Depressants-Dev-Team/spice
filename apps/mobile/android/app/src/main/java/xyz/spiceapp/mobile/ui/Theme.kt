...
val SpicePink = Color(0xFFEC4899)
val SpiceCyan = Color(0xFF38C8D9)
val SpiceOrange = Color(0xFFF97316)
val SpiceGreen = Color(0xFF10B981)
val SpiceGold = Color(0xFFF59E0B)
val SpiceRed = Color(0xFFFF003C)
val SpicePurple = Color(0xFF7C3AED)
...
fun AccentTheme.toColor(): Color =
    when (this) {
        ...
        AccentTheme.OceanBreeze -> Color(0xFF3B82F6)
...
@Composable
fun SpiceTheme(accentTheme: AccentTheme = AccentTheme.MidnightVelvet, content: @Composable () -> Unit) {
