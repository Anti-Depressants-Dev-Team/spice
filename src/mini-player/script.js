...
async function updateState() {
  try {
    ...
    if (state.repeat && state.repeat !== "off") {
      ...
      if (state.repeat === "one") {
        repeatBtn.innerHTML =
          '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4zm-4-2V9h-1l-2 1v1h1.5v4H13z"/></svg>';
      } else {
        repeatBtn.innerHTML =
...
document
  ...
  .addEventListener("click", () => sendControl("playpause"));
document
  .getElementById("btn-prev")
  .addEventListener("click", () => sendControl("prev"));
document
  .getElementById("btn-next")
  .addEventListener("click", () => sendControl("next"));
document
  .getElementById("btn-shuffle")
  .addEventListener("click", () => sendControl("shuffle"));
document
  .getElementById("btn-repeat")
  .addEventListener("click", () => sendControl("repeat"));
document
  .getElementById("btn-queue")
  .addEventListener("click", () => sendControl("queue"));
